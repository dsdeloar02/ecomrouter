...
const Single = ({ tceta }) => {
    const { title, price, image } = tceta;
    return (
        <div>
            <div className="max-w-sm h-[500px] bg-white rounded-lg my-3 shadow-md dark:bg-gray-800 dark:border-gray-700">

                <img className="p-8 rounded-t-lg m-auto  object-contain w-[200px] h-[250px]" src={image} alt="" />
